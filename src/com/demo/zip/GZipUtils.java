 ...
 */
	...
	private static void test1(){
		...
		try {
			...
			File fin = new File(Constants.TESTFILES_DIR + "/GZipUtils.zip");
	...
	private static void test2() throws IOException{
		String raw1 = "alkdgjl;jfsdl;djfeikl;fnlk;jsd;ldkjdsjkjg'sfz.dskf;lsjdf{\"androi{\"androidSdk\":22,\"androidVer\":\"5.1\",\"cpTime\":1612071603,\"cupABIs\":[\"armeabi-v7a\",\"armeabi\"],\"customId\":\"QT99999\"dSdk\":22,\"androidVer\":\"5.1\",\"cpTime\":1612071603,\"cupABIs\":[\"armeabi-v7a\",\"armeabi\"],\"customId\":\"QT99999\"";
		String raw2 = "aklsdglkdnfsdl;jfkssmdkm, ,.adsjlk;mlds;k{\"androidS{\"androidSdk\":22,\"androidVer\":\"5.1\",\"cpTime\":1612071603,\"cupABIs\":[\"armeabi-v7a\",\"armeabi\"],\"customId\":\"QT99999\"dk\":22,\"androidVer\":\"5.1\",\"cpTime\":1612071603,\"cupABIs\":[\"armeabi-v7a\",\"armeabi\"],\"customId\":\"QT99999\"flkd;sjf{\"androidSdk\":22,\"androidVer\":\"5.1\",\"cpTime\":1612071603,\"cupABIs\":[\"armeabi-v7a\",\"armeabi\"],\"customId\":\"QT99999\";";
		ByteArrayOutputStream out = new ByteArrayOutputStream();
		out.write(compress(raw1.getBytes()));
		out.write(compress(raw2.getBytes()));
		byte[] zipByteArray = out.toByteArray();
		
		byte[] unZippedArray = uncompress(zipByteArray);
		String str = new String(unZippedArray);
		if(str.equals(raw1 + raw2))
